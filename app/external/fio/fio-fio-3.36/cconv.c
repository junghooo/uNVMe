				  ...
				  size_t top_sz)
{
	...
	//add jh
	o->write_random_distribution = le32_to_cpu(top->write_random_distribution);
	o->write_zipf_theta.u.f = fio_uint64_to_double(le64_to_cpu(top->write_zipf_theta.u.i));
	o->write_pareto_h.u.f = fio_uint64_to_double(le64_to_cpu(top->write_pareto_h.u.i));
	o->write_gauss_dev.u.f = fio_uint64_to_double(le64_to_cpu(top->write_gauss_dev.u.i));
	o->write_random_center.u.f = fio_uint64_to_double(le64_to_cpu(top->write_random_center.u.i));
				   ...
				   struct thread_options *o)
{
	...
	//add jh
	top->write_random_distribution = cpu_to_le32(o->write_random_distribution);
	top->write_zipf_theta.u.i = __cpu_to_le64(fio_double_to_uint64(o->write_zipf_theta.u.f));
	top->write_pareto_h.u.i = __cpu_to_le64(fio_double_to_uint64(o->write_pareto_h.u.f));
	top->write_gauss_dev.u.i = __cpu_to_le64(fio_double_to_uint64(o->write_gauss_dev.u.f));
	top->write_random_center.u.i = __cpu_to_le64(fio_double_to_uint64(o->write_random_center.u.f));
